function [SideLobe,x,y] = phased_OPT(int,b)
data_pseudoarray;
% figure
% int=10;
i=1;
...
% M=bar(MainLobe);
% ylim([26 26.3])
% title('Main Lobe distribution | Cutoff @ 15 dB')
% xlabel('Trial #')
% ylabel('Magnitude')
...
title('Side Lobe Distribution | Cutoff @ 15 dB')
xlabel('Trial #')
ylabel('Magnitude')
...
% MS=bar(MLR);
% 
% title('Main Lobe to Side Lobe Ratio Distribution | Cutoff @ 15 dB')
% xlabel('Trial #')
% ylabel('Magnitude')
% for i=1:length(MLR)
